...
public class Menu implements Iterable<MenuItem> {
	 ...
	 */
	public void displayMenu(BTPlayer player) {
	 ...
	 */
	public void displayMenu(BTPlayer player, int page) {
	 ...
	 */
	public void displaySession(BTPlayer player, MenuSession session) {
	...
	public void refreshLater() {
		Bukkit.getScheduler().runTask(BTPlugin.plugin, this::refresh);
	}
	...
	void onCloseMenu(BTPlayer player) {
	 ...
	 */
	public Set<BTPlayer> getViewers() {
		return viewers;
	}
}
