...
public abstract class MenuItemValue<T> extends MenuItem {
	...
	@Override
	protected final void onClick(BTPlayer player) {
	...
	@Override
	protected final void onShiftClick(BTPlayer player) {
		T oldValue = valueCallback.getValue();
	...
	@Override
	protected final void onRightClick(BTPlayer player) {
		T oldValue = valueCallback.getValue();
	...
	@Override
	protected final void onShiftRightClick(BTPlayer player) {
		T oldValue = valueCallback.getValue();
	...
	protected void checkValidEntry(BTPlayer player, String entry) {
		try {
			...
			player.sendMessage(e.getMessage(), ChatColor.RED);
		}
	}
	 ...
	 */
	protected T onManualEntryComplete(BTPlayer player, String raw) throws IllegalArgumentException {return null;}
	/**
	 ...
	 */
	protected void onChange(BTPlayer player, T previous, T current) {}
	...
	public interface IMenuItemChange<T> {
		public void onChange(MenuItemValue<T> menuItem, BTPlayer player, T previous, T current);
	}
